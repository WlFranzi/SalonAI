...
window.LOCALES = {
  ...
  en: {
    ...
    manifesto_lede: "Europe doesn't look especially bold right now. We're falling behind on AI, and when you ask people what they themselves could actually do for Europe, the most common answer is a shrug. Many don't even feel particularly European — more like they happen to be here.",
  ...
  es: {
    ...
    manifesto_lede: "Europa no parece especialmente audaz en este momento. Vamos a la zaga en IA, y cuando preguntas qué puede uno mismo hacer por Europa, la respuesta más común es un encogimiento de hombros. Muchos ni siquiera se sienten especialmente europeos — más bien aquí por casualidad.",
  ...
  it: {
    ...
    manifesto_lede: "L'Europa non sembra particolarmente coraggiosa in questo momento. Siamo in ritardo sull'IA, e quando chiedi cosa si possa fare in prima persona per l'Europa, la risposta più frequente è un'alzata di spalle. Molti non si sentono nemmeno particolarmente europei — più che altro qui per caso.",
  ...
  pt: {
    ...
    manifesto_lede: "A Europa não parece particularmente arrojada neste momento. Estamos atrasados na IA, e quando se pergunta o que se pode fazer pessoalmente pela Europa, a resposta mais comum é um encolher de ombros. Muitos nem sequer se sentem particularmente europeus — mais como se estivessem aqui por acaso.",
  ...
  nl: {
    ...
    manifesto_lede: "Europa lijkt op dit moment niet bijzonder moedig. Bij AI lopen we achter, en als je vraagt wat je zelf voor Europa kunt doen, krijg je meestal een schouderophalen. Veel mensen voelen zich niet eens bijzonder Europees — meer alsof ze hier toevallig zijn.",
  ...
  pl: {
    ...
    manifesto_lede: "Europa nie sprawia teraz wrażenia szczególnie odważnej. W AI jesteśmy w tyle, a kiedy pytasz, co sam możesz zrobić dla Europy, najczęstszą odpowiedzią jest wzruszenie ramionami. Wielu nawet nie czuje się szczególnie po europejsku — raczej tak, jakby przypadkiem tu byli.",
  ...
  ro: {
    ...
    manifesto_lede: "Europa nu pare deosebit de îndrăzneață în acest moment. La AI suntem în urmă, iar când întrebi ce poți face tu însuți pentru Europa, cel mai frecvent răspuns este o ridicare din umeri. Mulți nici măcar nu se simt deosebit de europeni — mai degrabă aici din întâmplare.",
  ...
  sv: {
    ...
    manifesto_lede: "Europa ser inte särskilt djärvt ut just nu. På AI släpar vi efter, och när man frågar vad man själv kan göra för Europa möts man oftast av en axelryckning. Många känner sig inte ens särskilt europeiska — mer som att de råkar finnas här.",
  ...
  cs: {
    ...
    manifesto_lede: "Evropa právě teď nepůsobí zvlášť odvážně. V AI zaostáváme, a když se ptáš, co můžeš sám pro Evropu udělat, nejčastější odpovědí bývá pokrčení rameny. Mnozí se ani necítí nijak zvlášť evropsky — spíš jako by zde byli náhodou.",
  ...
  hu: {
    ...
    manifesto_lede: "Európa most nem tűnik túl bátornak. A mesterséges intelligenciában lemaradunk, és amikor megkérdezed, mit tehetsz te magad Európáért, a leggyakoribb válasz egy vállrándítás. Sokan nem is érzik magukat különösebben európainak — inkább csak véletlenül vannak itt.",
  ...
  sk: {
    ...
    manifesto_lede: "Európa práve teraz nepôsobí zvlášť odvážne. V AI zaostávame, a keď sa pýtaš, čo môžeš sám pre Európu urobiť, najčastejšou odpoveďou je pokrčenie ramien. Mnohí sa ani necítia nijak zvlášť európsky — skôr akoby tu boli náhodou.",
  ...
  bg: {
    ...
    manifesto_lede: "Европа в момента не изглежда особено смела. В областта на ИИ изоставаме, а когато попиташ какво сам можеш да направиш за Европа, най-честият отговор е свиване на рамене. Мнозина дори не се чувстват особено европейски — по-скоро сякаш са тук случайно.",
  ...
  da: {
    ...
    manifesto_lede: "Europa ser ikke særligt dristigt ud lige nu. Vi sakker bagud på AI, og når man spørger, hvad man selv kan gøre for Europa, er det almindeligste svar et skuldertræk. Mange føler sig ikke engang særligt europæiske — snarere som om de tilfældigvis er her.",
  ...
  ───────────────────────────────────────────────────────────────── */
    ...
    manifesto_lede: "Eurooppa ei näytä juuri nyt erityisen rohkealta. Tekoälyssä jäämme jälkeen, ja kun kysytään, mitä itse voit tehdä Euroopan hyväksi, yleisin vastaus on olankohautus. Monet eivät tunne itseään edes erityisen eurooppalaisiksi — pikemminkin sattumalta täällä.",
  ...
  hr: {
    ...
    manifesto_lede: "Europa upravo sada ne djeluje osobito odvažno. U AI-ju zaostajemo, a kada netko pita što sami možete učiniti za Europu, najčešći je odgovor slijeganje ramenima. Mnogi se ne osjećaju ni posebno europski — više kao da su slučajno ovdje.",
  ...
  el: {
    ...
    manifesto_lede: "Η Ευρώπη αυτή τη στιγμή δεν δείχνει ιδιαίτερα τολμηρή. Στην Τεχνητή Νοημοσύνη μένουμε πίσω, και όταν ρωτάς τι μπορείς ο ίδιος να κάνεις για την Ευρώπη, η συνηθέστερη απάντηση είναι ένα ανασήκωμα ώμων. Πολλοί δεν αισθάνονται καν ιδιαίτερα Ευρωπαίοι — μάλλον τυχαία βρίσκονται εδώ.",
  ...
  lt: {
    ...
    manifesto_lede: "Europa šiuo metu neatrodo ypač drąsi. DI srityje atsiliekame, o kai paklausi, ką pats gali padaryti dėl Europos, dažniausias atsakymas yra pečių gūžtelėjimas. Daugelis net nesijaučia ypač europiečiais — labiau atsitiktinai čia esantys.",
  ...
  lv: {
    ...
    manifesto_lede: "Eiropa pašlaik neizskatās īpaši drosmīga. MI jomā mēs atpaliekam, un, kad jautā, ko pats vari darīt Eiropas labā, biežākā atbilde ir plecu paraustīšana. Daudzi pat nejūtas īpaši eiropieši — drīzāk nejauši šeit.",
  ...
  et: {
    ...
    manifesto_lede: "Euroopa praegu eriti julge ei tundu. TI-s jääme maha, ja kui küsida, mida sa ise saaks Euroopa heaks teha, on kõige sagedasem vastus õlakehitus. Paljud ei tunne end isegi eriti eurooplaslikult — pigem juhuslikult siin.",
  ...
  sl: {
    ...
    manifesto_lede: "Evropa trenutno ne deluje posebej drzno. Pri umetni inteligenci zaostajamo, in ko vprašaš, kaj lahko sam storiš za Evropo, je najpogostejši odgovor skomig z rameni. Mnogi se ne počutijo niti posebej evropsko — bolj kot da so tu po naključju.",
  ...
  mt: {
    ...
    manifesto_lede: "L-Ewropa bħalissa ma tidhirx partikolarment kuraġġjuża. Fl-AI qed naqgħu lura, u meta titlob lil xi ħadd x'jista' jagħmel hu nnifsu għall-Ewropa, l-aktar tweġiba komuni hija tqanqilet spallejn. Ħafna lanqas iħossuhom partikolarment Ewropej — pjuttost qiegħdin hawn kważi b'kumbinazzjoni.",
  ...
  ga: {
    ...
    manifesto_lede: "Ní fheiceann an Eoraip rí-dhána i láthair na huaire. Táimid ag titim chun deiridh ar an IS, agus nuair a iarrtar cad is féidir leat féin a dhéanamh ar son na hEorpa, is é croitheadh guaillí an freagra is coitianta. Ní bhraitheann go leor daoine fiú go háirithe Eorpach — níos mó cosúil le go bhfuil siad anseo de thaisme.",
