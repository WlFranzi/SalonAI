...
window.LOCALES = {
  ...
  en: {
    ...
    host_own_desc: "Whatever the circle — team, friends, foundation, association, political office. You gather the people; we handle the rest: venue, catering, workshop, experts.",
    ...
    corp_desc: "For companies, boards and closed groups we curate Salon evenings to spec. Tell us who should be there and what the question of the evening is — we will get back to you within 48h with a proposal.",
  ...
  de: {
    ...
    host_own_desc: "Egal aus welchem Umfeld — Team, Freunde, Stiftung, Verein, Politik-Office. Du sammelst die Leute, wir kümmern uns um alles andere: Ort, Catering, Workshop, Experts.",
    ...
    corp_desc: "Für Firmen, Vorstände und geschlossene Gruppen kuratieren wir Salon-Abende nach Maß. Sag uns, wer dabei sein soll und was die Frage des Abends ist — wir melden uns innerhalb von 48h mit einem Vorschlag.",
  ...
  fr: {
    ...
    host_own_desc: "Quel que soit le cercle — équipe, amis, fondation, association, cabinet politique. Tu réunis les gens, on s'occupe de tout le reste : lieu, traiteur, atelier, experts.",
  ...
  es: {
    ...
    host_own_desc: "Sea cual sea el círculo — equipo, amigos, fundación, asociación, gabinete político. Tú reúnes a la gente; nosotros nos ocupamos de todo lo demás: lugar, catering, taller, expertos.",
  ...
  it: {
    ...
    host_own_desc: "Qualunque sia il cerchio — team, amici, fondazione, associazione, ufficio politico. Tu raduni le persone, pensiamo noi a tutto il resto: location, catering, workshop, esperti.",
  ...
  pt: {
    ...
    host_own_desc: "Seja qual for o círculo — equipa, amigos, fundação, associação, gabinete político. Tu reúnes as pessoas; nós tratamos do resto: local, catering, workshop, especialistas.",
  ...
  nl: {
    ...
    host_own_desc: "Welke kring dan ook — team, vrienden, stichting, vereniging, politiek bureau. Jij brengt de mensen samen, wij regelen de rest: locatie, catering, workshop, experts.",
  ...
  pl: {
    ...
    host_own_desc: "Jakikolwiek krąg — zespół, przyjaciele, fundacja, stowarzyszenie, biuro polityczne. Ty zbierasz ludzi, my zajmujemy się resztą: miejsce, catering, warsztat, eksperci.",
  ...
  ro: {
    ...
    host_own_desc: "Orice cerc — echipă, prieteni, fundație, asociație, birou politic. Tu aduni oamenii, noi ne ocupăm de restul: locație, catering, atelier, experți.",
  ...
  sv: {
    ...
    host_own_desc: "Vilken krets som helst — team, vänner, stiftelse, förening, politiskt kontor. Du samlar folket; vi ordnar resten: lokal, catering, workshop, experter.",
  ...
  cs: {
    ...
    host_own_desc: "Jakákoli skupina — tým, přátelé, nadace, sdružení, politická kancelář. Ty shromáždíš lidi, my se postaráme o zbytek: prostory, catering, workshop, experti.",
  ...
  hu: {
    ...
    host_own_desc: "Bármilyen kör — csapat, barátok, alapítvány, egyesület, politikai iroda. Te összegyűjtöd az embereket, mi intézzük a többit: helyszín, catering, workshop, szakértők.",
  ...
  sk: {
    ...
    host_own_desc: "Akákoľvek skupina — tím, priatelia, nadácia, združenie, politická kancelária. Ty zhromaždíš ľudí, my sa postaráme o zvyšok: priestory, catering, workshop, experti.",
  ...
  bg: {
    ...
    host_own_desc: "Какъвто и да е кръгът — екип, приятели, фондация, сдружение, политически офис. Ти събираш хората, ние се грижим за всичко останало: място, кетъринг, уъркшоп, експерти.",
  ...
  da: {
    ...
    host_own_desc: "Uanset kreds — team, venner, fond, forening, politisk kontor. Du samler folkene; vi tager os af resten: lokale, catering, workshop, eksperter.",
  ...
  ───────────────────────────────────────────────────────────────── */
    ...
    host_own_desc: "Mikä piiri tahansa — tiimi, ystävät, säätiö, yhdistys, poliittinen toimisto. Sinä kokoat ihmiset, me hoidamme loput: paikka, catering, työpaja, asiantuntijat.",
  ...
  hr: {
    ...
    host_own_desc: "Bilo kakav krug — tim, prijatelji, zaklada, udruga, politički ured. Ti okupljaš ljude, mi se brinemo za ostalo: prostor, catering, radionica, stručnjaci.",
  ...
  el: {
    ...
    host_own_desc: "Οποιοσδήποτε κύκλος — ομάδα, φίλοι, ίδρυμα, σύλλογος, πολιτικό γραφείο. Εσύ μαζεύεις τους ανθρώπους· εμείς αναλαμβάνουμε τα υπόλοιπα: χώρος, catering, workshop, ειδικοί.",
  ...
  lt: {
    ...
    host_own_desc: "Bet koks ratas — komanda, draugai, fondas, asociacija, politinis biuras. Tu surenki žmones, mes pasirūpiname likusiu: vieta, maitinimas, dirbtuvė, ekspertai.",
  ...
  lv: {
    ...
    host_own_desc: "Jebkurš loks — komanda, draugi, fonds, biedrība, politiskais birojs. Tu sapulcini cilvēkus, pārējo darīsim mēs: vieta, ēdināšana, darbnīca, eksperti.",
  ...
  et: {
    ...
    host_own_desc: "Mis tahes ring — meeskond, sõbrad, fond, ühing, poliitiline büroo. Sina kogud inimesed, ülejäänu teeme meie: koht, toitlustus, töötuba, eksperdid.",
  ...
  sl: {
    ...
    host_own_desc: "Kakršen koli krog — ekipa, prijatelji, fundacija, društvo, politični urad. Ti zbereš ljudi, mi poskrbimo za ostalo: prostor, catering, delavnica, strokovnjaki.",
  ...
  mt: {
    ...
    host_own_desc: "Liema ċirku — team, ħbieb, fondazzjoni, għaqda, uffiċċju politiku. Int tiġbor in-nies, aħna nieħdu ħsieb il-bqija: post, catering, workshop, esperti.",
  ...
  ga: {
    ...
    host_own_desc: "Cibé ciorcal — foireann, cairde, fondúireacht, cumann, oifig pholaitiúil. Tugann tú na daoine le chéile, déanaimid an chuid eile: ionad, lónadóireacht, ceardlann, saineolaithe.",
