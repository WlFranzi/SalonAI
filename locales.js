...
window.LOCALES = {
  ...
  en: {
    ...
    corp_h3: "Or bring your team.",
    corp_desc: "For companies, boards and closed groups I curate Salon evenings to spec. Tell me who should be there and what the question of the evening is — I will get back to you within 48h with a proposal.",
    corp_btn: "Send inquiry →",
    corp_fine: "Private Salon · Executive Roundtable · Team Workshop · Curated to spec · Price on request.",
    faq_label: "FAQ",
  ...
  de: {
    ...
    corp_h3: "Oder bring dein Team.",
    corp_desc: "Für Firmen, Vorstände und geschlossene Gruppen kuratiere ich Salon-Abende nach Maß. Sag mir, wer dabei sein soll und was die Frage des Abends ist — ich melde mich innerhalb von 48h mit einem Vorschlag.",
    corp_btn: "Anfrage senden →",
    corp_fine: "Privat-Salon · Executive Roundtable · Team-Workshop · Auf Maß kuratiert · Preis nach Anfrage.",
    faq_label: "FAQ",
