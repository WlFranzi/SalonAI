...
window.LOCALES = {
  ...
  en: {
    ...
    faq_q1: "Who's behind the Salon — and why should I trust them?",
    faq_a1: "Salon AI is founded and led by <strong>Franziska Wittleder</strong>. 15+ years in AI, engineering and product leadership across scale-ups and big tech (Amazon, Writer and SoundCloud). Lived and worked in the US for several years. Creative direction by Tatjana Mallinckrodt (Head of PR &amp; Brand Strategy at Gestalten / teNeues) — because tech doesn't have to be sterile. 🌿",
  ...
  de: {
    ...
    faq_q1: "Wer steht hinter dem Salon — und warum sollte ich vertrauen?",
    faq_a1: "Salon AI wird von <strong>Franziska Wittleder</strong> gegründet und geleitet. 15+ Jahre in KI, Engineering und Product Leadership in Scale-ups als auch in Big Tech (Amazon, Writer und SoundCloud). Viele Jahre in den USA gelebt und gearbeitet. Creative Direction von Tatjana Mallinckrodt (Head of PR &amp; Brand Strategy bei Gestalten / teNeues), denn Tech muss nicht steril sein. 🌿",
