...
window.LOCALES = {
  ...
  en: {
    ...
    manifesto_coda: "One more thing: this happens offline. With real people at real tables. Online courses exist in abundance. But the conversations that actually change something usually still happen where people sit together and start thinking bigger. <strong><em>Past rounds have brought together decision-makers from business, agencies, media, academia and politics.</em></strong>",
  ...
  de: {
    ...
    manifesto_coda: "Wichtig ist auch: Das Ganze passiert offline. Mit echten Menschen an echten Tischen. Online-Kurse gibt es genug. Aber die Gespräche, die wirklich etwas verändern, entstehen meistens immer noch dort, wo Menschen zusammen sitzen und anfangen, größer zu denken. <strong><em>Unsere bisherigen Runden vereinten Entscheidungsträger:innen aus Wirtschaft, Agenturen, Medien, Wissenschaft und Politik.</em></strong>",
