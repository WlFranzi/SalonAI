...
window.LOCALES = {
  ...
  en: {
    ...
    stat_4_num:    "From the first click",
    stat_4_lbl:    "Even without AI experience.",
    col_old:       "Before",
    ...
    past_events_intro: "Salon AI happens offline — real people, real tables. Online courses are abundant. The conversations that actually change something usually emerge where people come together and think bigger.",
  },
  ...
  de: {
    ...
    stat_4_num:    "Vom ersten Klick",
    stat_4_lbl:    "Auch ohne KI-Erfahrung.",
    col_old:       "Früher",
    ...
    past_events_intro: "Salon AI passiert offline – mit echten Menschen an echten Tischen. Online-Kurse gibt es genug. Die Gespräche, die wirklich etwas verändern, entstehen meist dort, wo Menschen zusammenkommen und größer denken.",
  },
  ...
  fr: {
    ...
    stat_4_num:    "Dès le premier clic",
    stat_4_lbl:    "Même sans expérience en IA.",
    col_old:       "Avant",
  ...
  es: {
    ...
    hero_strapline: "Porque la única forma de saber dónde están realmente tú y tu equipo con la IA es haberla construido tú mismo.",
    ...
    stat_4_num:    "Desde el primer clic",
    stat_4_lbl:    "Incluso sin experiencia en IA.",
    col_old:       "Antes",
    col_now:       "Con IA hoy",
  ...
  it: {
    ...
    hero_strapline: "Perché l'unico modo per sapere dove sei davvero tu e il tuo team con l'IA è averla costruita tu stesso.",
    ...
    stat_4_num:    "Dal primo clic",
    stat_4_lbl:    "Anche senza esperienza in IA.",
    col_old:       "Prima",
  ...
  pt: {
    ...
    hero_strapline: "Porque a única forma de saber onde tu e a tua equipa estão realmente em relação à IA é tê-la construído tu próprio.",
    ...
    stat_4_num:    "Do primeiro clique",
    stat_4_lbl:    "Mesmo sem experiência em IA.",
    col_old:       "Antes",
    col_now:       "Com IA hoje",
  ...
  nl: {
    ...
    hero_strapline: "Want de enige manier om te weten waar jij en je team echt staan met AI is door het zelf te hebben gebouwd.",
    ...
    stat_4_num:    "Vanaf de eerste klik",
    stat_4_lbl:    "Ook zonder AI-ervaring.",
    col_old:       "Vroeger",
  ...
  pl: {
    ...
    hero_strapline: "Bo jedynym sposobem, by wiedzieć, gdzie naprawdę jesteście Ty i Twój zespół z AI, jest samodzielne jej zbudowanie.",
    ...
    stat_4_num:    "Od pierwszego kliknięcia",
    stat_4_lbl:    "Nawet bez doświadczenia z AI.",
    col_old:       "Wcześniej",
    col_now:       "Dziś z AI",
  ...
  ro: {
    ...
    hero_strapline: "Pentru că singura modalitate de a ști unde te afli cu adevărat tu și echipa ta cu AI este să fi construit-o tu însuți.",
    ...
    stat_4_num:    "De la primul click",
    stat_4_lbl:    "Chiar și fără experiență cu AI.",
    col_old:       "Înainte",
    col_now:       "Cu AI azi",
  ...
  sv: {
    ...
    hero_strapline: "För det enda sättet att veta var du och ditt team verkligen står med AI är att själv ha byggt med den.",
    ...
    stat_4_num:    "Från första klicket",
    stat_4_lbl:    "Även utan AI-erfarenhet.",
    col_old:       "Tidigare",
    col_now:       "Med AI idag",
  ...
  cs: {
    ...
    hero_strapline: "Protože jediný způsob, jak vědět, kde s AI opravdu stojíš ty a tvůj tým, je sám si ji postavit.",
    ...
    stat_4_num:    "Od prvního kliknutí",
    stat_4_lbl:    "I bez zkušeností s AI.",
    col_old:       "Dříve",
    col_now:       "Dnes s AI",
  ...
  hu: {
    ...
    hero_strapline: "Mert csak akkor tudhatod, hol tartotok te és a csapatod valójában az AI-jal, ha magad építettél vele.",
    ...
    stat_4_num:    "Az első kattintástól",
    stat_4_lbl:    "Akár AI-tapasztalat nélkül is.",
    col_old:       "Korábban",
    col_now:       "Ma AI-val",
  ...
  sk: {
    ...
    hero_strapline: "Pretože jediný spôsob, ako vedieť, kde s AI naozaj stojíš ty a tvoj tím, je sám si ju postaviť.",
    ...
    stat_4_num:    "Od prvého kliknutia",
    stat_4_lbl:    "Aj bez skúseností s AI.",
    col_old:       "Skôr",
    col_now:       "Dnes s AI",
  ...
  bg: {
    ...
    hero_strapline: "Защото единственият начин да разбереш къде наистина се намираш ти и екипът ти с ИИ е сам да си го изградил.",
    ...
    stat_4_num:    "От първия клик",
    stat_4_lbl:    "Дори без опит с ИИ.",
    col_old:       "Преди",
    col_now:       "С AI днес",
  ...
  da: {
    ...
    hero_strapline: "For den eneste måde at vide, hvor du og dit team virkelig står med AI, er at have bygget med den selv.",
    ...
    stat_4_num:    "Fra det første klik",
    stat_4_lbl:    "Også uden AI-erfaring.",
    col_old:       "Tidligere",
  ...
  ───────────────────────────────────────────────────────────────── */
    ...
    hero_strapline: "Koska ainoa tapa tietää, missä sinä ja tiimisi todella ovat tekoälyn suhteen, on rakentaa sillä itse.",
    ...
    stat_4_num:    "Ensimmäisestä klikistä",
    stat_4_lbl:    "Myös ilman tekoälykokemusta.",
    col_old:       "Ennen",
  ...
  hr: {
    ...
    hero_strapline: "Jer jedini način da znaš gdje ti i tvoj tim zaista stojite s AI-jem jest da si sam s njim gradio.",
    ...
    stat_4_num:    "Od prvog klika",
    stat_4_lbl:    "I bez iskustva s AI-jem.",
    col_old:       "Prije",
    col_now:       "S AI danas",
  ...
  el: {
    ...
    hero_strapline: "Γιατί ο μόνος τρόπος να ξέρεις πού στέκεστε εσύ και η ομάδα σου πραγματικά με την AI είναι να την έχεις χτίσει ο ίδιος.",
    ...
    stat_4_num:    "Από το πρώτο κλικ",
    stat_4_lbl:    "Ακόμα και χωρίς εμπειρία με AI.",
    col_old:       "Πριν",
  ...
  lt: {
    ...
    hero_strapline: "Nes vienintelis būdas sužinoti, kur tu ir tavo komanda iš tikrųjų esate dirbtinio intelekto srityje, yra pačiam jį sukurti.",
    ...
    stat_4_num:    "Nuo pirmo paspaudimo",
    stat_4_lbl:    "Net be DI patirties.",
    col_old:       "Anksčiau",
  ...
  lv: {
    ...
    hero_strapline: "Jo vienīgais veids, kā uzzināt, kur tu un tava komanda patiesi atrodaties ar MI, ir to pašam būvēt.",
    ...
    stat_4_num:    "No pirmā klikšķa",
    stat_4_lbl:    "Arī bez MI pieredzes.",
    col_old:       "Agrāk",
  ...
  et: {
    ...
    hero_strapline: "Sest ainus viis teada saada, kus sa ja su meeskond AI-ga tegelikult oleme, on see ise üles ehitada.",
    ...
    stat_4_num:    "Esimesest klõpsust",
    stat_4_lbl:    "Ka ilma AI kogemuseta.",
    col_old:       "Varem",
    col_now:       "Täna AI-ga",
  ...
  sl: {
    ...
    hero_strapline: "Ker je edini način, da veš, kje sta s svojo ekipo zares pri UI, ta, da si jo sam zgradil.",
    ...
    stat_4_num:    "Od prvega klika",
    stat_4_lbl:    "Tudi brez izkušenj z UI.",
    col_old:       "Prej",
    col_now:       "Z AI danes",
  ...
  mt: {
    ...
    hero_strapline: "Għax l-uniku mod biex tkun taf fejn int u t-tim tiegħek tassew waqt l-AI hu li tkun bnejt biha int stess.",
    ...
    stat_4_num:    "Mill-ewwel klikk",
    stat_4_lbl:    "Anki mingħajr esperjenza fl-AI.",
    col_old:       "Qabel",
    col_now:       "Mal-AI llum",
  ...
  ga: {
    ...
    hero_strapline: "Mar is é an t-aon bhealach lena fhios cá bhfuilir féin agus do fhoireann i ndáiríre le AI ná é a thógáil tú féin.",
    ...
    stat_4_num:    "Ón gcéad chliceáil",
    stat_4_lbl:    "Fiú gan taithí ar AI.",
    col_old:       "Roimhe seo",
    col_now:       "Le AI inniu",
