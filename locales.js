...
window.LOCALES = {
  ...
  en: {
    ...
    skills_desc:   "In the first part of the evening you set up your personal AI agent for your own everyday challenges — gaining real hands-on experience. In the second part you use your agent to build a concrete plan: what you can already do today, without being in politics, to strengthen the EU.",
  ...
  de: {
    ...
    skills_desc:   "Im ersten Teil richtest du deinen persönlichen KI-Agenten für deine eigenen Alltagsherausforderungen ein — und sammelst echte Erfahrung. Im zweiten Teil nutzt du deinen Agenten, um einen konkreten Plan zu erarbeiten: was du heute schon tun kannst, ohne Politiker zu sein, um die EU zu stärken.",
  ...
  fr: {
    ...
    skills_desc:   "Dans la première partie, tu configures ton agent IA personnel pour tes défis du quotidien — en acquérant une vraie expérience pratique. Dans la seconde partie, tu utilises ton agent pour élaborer un plan concret : ce que tu peux déjà faire aujourd'hui, sans être en politique, pour renforcer l'UE.",
  ...
  es: {
    ...
    skills_desc:   "En la primera parte de la velada configuras tu agente de IA personal para tus propios retos cotidianos — adquiriendo experiencia real. En la segunda parte usas tu agente para elaborar un plan concreto: lo que ya puedes hacer hoy, sin ser político, para fortalecer la UE.",
  ...
  it: {
    ...
    skills_desc:   "Nella prima parte della serata configuri il tuo agente AI personale per le tue sfide quotidiane — acquisendo vera esperienza pratica. Nella seconda parte usi il tuo agente per elaborare un piano concreto: cosa puoi già fare oggi, senza fare politica, per rafforzare l'UE.",
  ...
  pt: {
    ...
    skills_desc:   "Na primeira parte da noite configuras o teu agente de IA pessoal para os teus desafios do dia a dia — ganhando experiência prática real. Na segunda parte usas o teu agente para elaborar um plano concreto: o que já podes fazer hoje, sem ser político, para fortalecer a UE.",
  ...
  nl: {
    ...
    skills_eyebrow: "AI Workshop",
    skills_desc:   "In het eerste deel van de avond stel je je persoonlijke AI-agent in voor je eigen dagelijkse uitdagingen — en doe je echte hands-on ervaring op. In het tweede deel gebruik je je agent om een concreet plan op te stellen: wat je vandaag al kunt doen, zonder politicus te zijn, om de EU te versterken.",
  ...
  pl: {
    ...
    skills_desc:   "W pierwszej części wieczoru konfigurujesz swojego osobistego agenta AI do własnych codziennych wyzwań — zdobywając prawdziwe doświadczenie. W drugiej części używasz agenta, aby stworzyć konkretny plan: co możesz już dziś zrobić, bez bycia politykiem, aby wzmocnić UE.",
  ...
  ro: {
    ...
    skills_desc:   "În prima parte a serii îți configurezi agentul AI personal pentru propriile provocări cotidiene — câștigând experiență practică reală. În a doua parte îți folosești agentul pentru a elabora un plan concret: ce poți deja face astăzi, fără a fi politician, pentru a consolida UE.",
  ...
  sv: {
    ...
    skills_eyebrow: "AI Workshop",
    skills_desc:   "I kvällens första del ställer du in din personliga AI-agent för dina egna vardagsutmaningar — och skaffar dig verklig praktisk erfarenhet. I den andra delen använder du din agent för att ta fram en konkret plan: vad du redan idag kan göra, utan att vara politiker, för att stärka EU.",
  ...
  cs: {
    ...
    skills_eyebrow: "AI Workshop",
    skills_desc:   "V první části večera si nastavíš svého osobního AI agenta pro vlastní každodenní výzvy — a získáš skutečné praktické zkušenosti. Ve druhé části použiješ agenta k sestavení konkrétního plánu: co již dnes můžeš udělat, aniž bys byl/a politik/politička, pro posílení EU.",
  ...
  hu: {
    ...
    skills_eyebrow: "AI Workshop",
    skills_desc:   "Az este első részében beállítod személyes AI-ügynöködet a saját mindennapos kihívásaidhoz — valódi, gyakorlati tapasztalatot szerezve. A második részben az ügynöködet használod egy konkrét terv kidolgozásához: mit tehetsz már ma, politikus nélkül, az EU erősítéséért.",
  ...
  sk: {
    ...
    skills_eyebrow: "AI Workshop",
    skills_desc:   "V prvej časti večera si nastavíš svojho osobného AI agenta pre vlastné každodenné výzvy — a získaš skutočné praktické skúsenosti. V druhej časti použiješ agenta na zostavenie konkrétneho plánu: čo už dnes môžeš urobiť, bez toho aby si bol/a politik/politička, pre posilnenie EÚ.",
  ...
  bg: {
    ...
    skills_desc:   "В първата част на вечерта настройваш личния си AI агент за собствените си ежедневни предизвикателства — придобивайки реален практически опит. Във втората част използваш агента, за да изградиш конкретен план: какво вече можеш да правиш днес, без да си политик, за да укрепиш ЕС.",
  ...
  da: {
    ...
    skills_eyebrow: "AI Workshop",
    skills_desc:   "I aftenens første del opsætter du din personlige AI-agent til dine egne hverdagsudfordringer — og opnår reel praktisk erfaring. I anden del bruger du din agent til at udarbejde en konkret plan: hvad du allerede i dag kan gøre, uden at være politiker, for at styrke EU.",
  ...
  ───────────────────────────────────────────────────────────────── */
    ...
    skills_desc:   "Illan ensimmäisessä osassa asetat henkilökohtaisen AI-agenttisi omia arkipäivän haasteitasi varten — hankkien todellista käytännön kokemusta. Toisessa osassa käytät agenttiasi konkreettisen suunnitelman laatimiseen: mitä voit jo tänään tehdä, ilman poliitikkona olemista, EU:n vahvistamiseksi.",
  ...
  hr: {
    ...
    skills_desc:   "U prvom dijelu večeri postavljaš svog osobnog AI agenta za vlastite svakodnevne izazove — stječući stvarno praktično iskustvo. U drugom dijelu koristiš agenta za izradu konkretnog plana: što već danas možeš učiniti, bez bavljenja politikom, za jačanje EU-a.",
  ...
  el: {
    ...
    skills_desc:   "Στο πρώτο μέρος της βραδιάς ρυθμίζεις τον προσωπικό σου AI πράκτορα για τις δικές σου καθημερινές προκλήσεις — αποκτώντας πραγματική πρακτική εμπειρία. Στο δεύτερο μέρος χρησιμοποιείς τον πράκτορά σου για να διαμορφώσεις ένα συγκεκριμένο σχέδιο: τι μπορείς ήδη να κάνεις σήμερα, χωρίς να είσαι πολιτικός, για να ενισχύσεις την ΕΕ.",
  ...
  lt: {
    ...
    skills_desc:   "Pirmoje vakaro dalyje sukonfigūruoji savo asmeninį AI agentą savo kasdieniams iššūkiams spręsti — įgydamas/įgydama tikros praktinės patirties. Antroje dalyje naudoji agentą konkrečiam planui parengti: ką jau šiandien gali padaryti, nebūdamas/nebūdama politiku, ES stiprinimui.",
  ...
  lv: {
    ...
    skills_desc:   "Vakara pirmajā daļā tu iestatī savu personīgo AI aģentu saviem ikdienas izaicinājumiem — iegūstot reālu praktisko pieredzi. Otrajā daļā tu izmanto aģentu, lai izstrādātu konkrētu plānu: ko tu jau šodien vari darīt, nebūdams/nebūdama politiķis, lai stiprinātu ES.",
  ...
  et: {
    ...
    skills_desc:   "Õhtu esimeses osas seadistad oma isikliku AI-agendi oma igapäevastele väljakutsetele — omandades tõelist praktilist kogemust. Teises osas kasutad agenti konkreetse plaani koostamiseks: mida saad juba täna teha, ilma et oleksid poliitik, Euroopa Liidu tugevdamiseks.",
  ...
  sl: {
    ...
    skills_desc:   "V prvem delu večera nastaviš svojega osebnega AI agenta za lastne vsakodnevne izzive — in pridobiš resnične praktične izkušnje. V drugem delu uporabiš agenta za pripravo konkretnega načrta: kaj že danes lahko storiš, brez da bi bil/a politik, za krepitev EU.",
  ...
  mt: {
    ...
    skills_desc:   "Fl-ewwel parti tal-lejla twaqqaf l-aġent AI personali tiegħek għall-isfidi ta' kuljum tiegħek stess — u tikseb esperjenza prattika reali. Fit-tieni parti tuża l-aġent tiegħek biex tibni pjan konkret: x'tista' diġà tagħmel illum, mingħajr ma tkun fil-politika, biex issaħħaħ l-UE.",
  ...
  ga: {
    ...
    skills_desc:   "Sa chéad chuid den oíche socraíonn tú d'ghníomhaire AI pearsanta do dhúshláin laethúla féin — ag fáil taithí phraiticiúil iarbhír. Sa dara cuid úsáideann tú d'ghníomhaire chun plean nithiúil a tharraingt suas: cad is féidir leat a dhéanamh cheana féin inniu, gan bheith i do pholaiteoir, chun an AE a neartú.",
