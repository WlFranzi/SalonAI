...
window.LOCALES = {
  ...
  en: {
    ...
    skills_desc:   "You build your own personal AI agent — and use it to understand what you can already do today to strengthen Europe. From your own home.",
  ...
  de: {
    ...
    skills_desc:   "Du erstellst deinen persönlichen KI-Agenten — und nutzt ihn, um zu verstehen, was du heute schon tun kannst, um Europa zu stärken. Von zuhause.",
  ...
  fr: {
    ...
    skills_desc:   "Tu crées ton agent IA personnel — et tu l'utilises pour découvrir ce que tu peux déjà faire aujourd'hui pour renforcer l'Europe. Depuis chez toi.",
  ...
  es: {
    ...
    skills_desc:   "Creas tu agente de IA personal — y lo usas para entender lo que ya puedes hacer hoy para fortalecer Europa. Desde tu propia casa.",
  ...
  it: {
    ...
    skills_desc:   "Crei il tuo agente AI personale — e lo usi per scoprire cosa puoi già fare oggi per rafforzare l'Europa. Da casa tua.",
  ...
  pt: {
    ...
    skills_desc:   "Crias o teu agente de IA pessoal — e usas-o para entender o que já podes fazer hoje para fortalecer a Europa. A partir de casa.",
  ...
  nl: {
    ...
    skills_eyebrow: "AI Workshop",
    skills_desc:   "Je bouwt je eigen AI-agent — en gebruikt die om te begrijpen wat je vandaag al kunt doen om Europa te versterken. Vanuit je eigen huis.",
  ...
  pl: {
    ...
    skills_desc:   "Tworzysz własnego agenta AI — i używasz go, aby zrozumieć, co już dziś możesz zrobić, aby wzmocnić Europę. Z własnego domu.",
  ...
  ro: {
    ...
    skills_desc:   "Îți creezi propriul agent AI — și îl folosești pentru a înțelege ce poți face deja astăzi pentru a consolida Europa. De acasă.",
  ...
  sv: {
    ...
    skills_eyebrow: "AI Workshop",
    skills_desc:   "Du bygger din personliga AI-agent — och använder den för att förstå vad du redan idag kan göra för att stärka Europa. Hemifrån.",
  ...
  cs: {
    ...
    skills_eyebrow: "AI Workshop",
    skills_desc:   "Vytvoříš svého osobního AI agenta — a použiješ ho, abys pochopil/a, co už dnes můžeš udělat pro posílení Evropy. Z domova.",
  ...
  hu: {
    ...
    skills_eyebrow: "AI Workshop",
    skills_desc:   "Megalkotod a saját személyes AI-ügynöködet — és felhasználod, hogy megértsd, mit tehetsz már ma Európa erősítéséért. Otthonodból.",
  ...
  sk: {
    ...
    skills_eyebrow: "AI Workshop",
    skills_desc:   "Vytvoríš svojho osobného AI agenta — a použiješ ho, aby si pochopil/a, čo už dnes môžeš urobiť pre posilnenie Európy. Z domova.",
  ...
  bg: {
    ...
    skills_desc:   "Създаваш своя личен AI агент — и го използваш, за да разбереш какво вече можеш да правиш днес, за да укрепиш Европа. От дома си.",
  ...
  da: {
    ...
    skills_eyebrow: "AI Workshop",
    skills_desc:   "Du bygger din personlige AI-agent — og bruger den til at forstå, hvad du allerede i dag kan gøre for at styrke Europa. Hjemmefra.",
  ...
  ───────────────────────────────────────────────────────────────── */
    ...
    skills_desc:   "Rakennat oman henkilökohtaisen AI-agenttisi — ja käytät sitä ymmärtääksesi, mitä voit jo tänään tehdä Euroopan vahvistamiseksi. Kotoa käsin.",
  ...
  hr: {
    ...
    skills_desc:   "Stvaraš svog osobnog AI agenta — i koristiš ga da razumiješ što već danas možeš učiniti za jačanje Europe. Iz svog doma.",
  ...
  el: {
    ...
    skills_desc:   "Δημιουργείς τον προσωπικό σου AI πράκτορα — και τον χρησιμοποιείς για να καταλάβεις τι μπορείς ήδη να κάνεις σήμερα για να ενισχύσεις την Ευρώπη. Από το σπίτι σου.",
  ...
  lt: {
    ...
    skills_desc:   "Sukuri savo asmeninį AI agentą — ir naudoji jį suprasti, ką jau šiandien gali padaryti Europai stiprinti. Iš namų.",
  ...
  lv: {
    ...
    skills_desc:   "Tu izveido savu personīgo AI aģentu — un izmanto to, lai saprastu, ko jau šodien vari darīt Eiropas stiprināšanai. No mājām.",
  ...
  et: {
    ...
    skills_desc:   "Lood oma isikliku AI-agendi — ja kasutad seda, et mõista, mida saad juba täna teha Euroopa tugevdamiseks. Kodust.",
  ...
  sl: {
    ...
    skills_desc:   "Ustvariš svojega osebnega AI agenta — in ga uporabiš, da razumeš, kaj že danes lahko storiš za krepitev Evrope. Od doma.",
  ...
  mt: {
    ...
    skills_desc:   "Toħloq l-aġent AI personali tiegħek — u tuża' biex tifhem x'diġà tista' tagħmel illum biex issaħħaħ l-Ewropa. Mid-dar tiegħek.",
  ...
  ga: {
    ...
    skills_desc:   "Cruthaíonn tú d'ghníomhaire AI pearsanta — agus úsáideann tú é chun tuiscint a fháil ar cad is féidir leat a dhéanamh cheana féin inniu chun an Eoraip a neartú. Ó do bhaile.",
